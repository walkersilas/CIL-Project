...
class AutoEncoder(pl.LightningModule):
    def __init__(self, number_of_users, number_of_movies, encoding_size, all_data):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(in_features=number_of_movies, out_features=512),
            nn.ReLU(),
            nn.Linear(in_features=512, out_features=256),
            nn.ReLU(),
            nn.Linear(in_features=256, out_features=encoding_size),
            nn.ReLU()
        )

        # Decoder part of the Autoencoder
        self.decoder = nn.Sequential(
            nn.Linear(in_features=encoding_size, out_features=256),
            nn.ReLU(),
            nn.Linear(in_features=256, out_features=512),
            nn.ReLU(),
            nn.Linear(in_features=512, out_features=number_of_movies),
            nn.ReLU()
        )
