...
from modules import test_reliability_predictor_other_network
import numpy as np
import pandas as pd
import os
import torch
...
def main():
    ...
    config = get_config(args, test_reliability_predictor_other_network.hyper_parameters)
    ...
    reliability_predictor = test_reliability_predictor_other_network.RELIABILITY_PREDICTOR(
