...
This modules trains and tests the SlopeOne model.
"""

import numpy as np
from comet_ml import Experiment

from modules import slopeone
...
def main():
    ...
    algo = slopeone.SlopeOne(train_data, test_data, test_ids, args, config, comet_logger)
