...
from modules import reinforced_gnn_ncf_att
...
def main():
    ...
    config = get_config(args, reinforced_gnn_ncf_att.hyper_parameters)
    ...
    graph_neural_network = reinforced_gnn_ncf_att.GNN(
    ...
    checkpoint_filename = "reinforced_gnn_ncf_att_" + str(get_hash(config, args))
    ...
    best_graph_neural_network = reinforced_gnn_ncf_att.GNN.load_from_checkpoint(
