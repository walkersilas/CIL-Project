...
This modules trains and tests the baseline GNN model.
"""
...
def main():
    ...
    graph_neural_network = gnn_baseline.GNN(
    ...
    best_graph_neural_network = gnn_baseline.GNN.load_from_checkpoint(
