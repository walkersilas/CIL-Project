...
class NCF(pl.LightningModule):
    def __init__(self, number_of_users, number_of_movies, embedding_size):
        ...
        self.mlp_embedding_layer_users = nn.Linear(number_of_users, embedding_size)
        self.mlp_embedding_layer_movies = nn.Linear(number_of_movies, embedding_size)

        self.gmf_embedding_layer_users = nn.Linear(number_of_users, embedding_size)
        self.gmf_embedding_layer_movies = nn.Linear(number_of_movies, embedding_size)
        ...
        self.prediction_layer = nn.Linear(in_features=8 + embedding_size, out_features=1)
