...
[![build](https://github.com/walkersilas/CIL-Project/actions/workflows/build.yml/badge.svg)](https://github.com/walkersilas/CIL-Project/actions/workflows/build.yml)
...
- `/report`: Source code used to generate the report in LaTeX.
...
This section shortly describes the necessary commands to reproduce the experiments for our project. Note that the following code snippets all assume that the current working directory is `CIL-Project/src/mains`.
